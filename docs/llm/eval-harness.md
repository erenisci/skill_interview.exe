...
| `disambiguation.jsonl`          | Ambiguous skill names with real candidate sets — Zustand/Pompeii, Tauri/the ancient people, Vitest/Playwright, Redis/JavaGuide | Is the right candidate chosen, and is "none" chosen when it should be? |
