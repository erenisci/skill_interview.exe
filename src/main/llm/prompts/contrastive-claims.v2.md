...
Write between 0 and 5 statements per side.
...
**Write every statement in {{LANGUAGE}}.** The material above is in whatever language it was published in, and that
has no bearing on this: match the language named here, not the language you have just been reading. If they differ,
this instruction wins. Statements in the wrong language are discarded, and a discarded statement is a question the
reader never sees.

Keep technical terms, product names, and command names in their original form — never translate them. A reader
preparing for an interview needs the words the interview will use.
